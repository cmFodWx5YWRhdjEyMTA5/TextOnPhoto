...
public abstract class Sticker {
    ...
    public void setBackgroundEnable(boolean backgroundEnable) {
        this.backgroundEnable = backgroundEnable;
    }
    ...
    public void setPoint(PointF pointCenter) {
        if (pointF == null)
            pointF = new PointF();
        pointF = pointCenter;
    }
    ...
    @NonNull
    public abstract Sticker setShadowLayer(float radius, float dx, float dy, int shadowColor, int shadowType);

    @NonNull
    public abstract Sticker setTextSkewX(float skewX);
    ...
    @NonNull
    public abstract TextSticker setTextNeon(float radius, float dx, float dy, int shadowColor, int neonType);
